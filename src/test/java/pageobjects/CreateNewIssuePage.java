...
public class CreateNewIssuePage {
	...
	public void clickbutton() {
        try {
         WebElement ele= wait.waitForClickability(createnewticketbtn);
         ele.click();
        }
        catch (Exception e){
            js.executeScript("arguments[0].click();", createnewticketbtn);        }
	...
	public void createnewissue(String storeInput, String expectedStoreText, String category, String deviceId,
		...
		Dropdownutils.safeSelectFromAutoSuggest(driver, storenamedrp, storeoptions, storeInput, expectedStoreText);
